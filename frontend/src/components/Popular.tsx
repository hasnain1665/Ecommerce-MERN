...
const Popular = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-[10px] mb-[60px] sm:mb-[80px] lg:mb-[100px] px-4">
      ...
      <div
        className="mt-[30px] sm:mt-[40px] lg:mt-[50px] grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 
      gap-4 sm:gap-6 lg:gap-[30px] px-6 sm:px-8 lg:px-10 w-full max-w-[1400px]"
      >
