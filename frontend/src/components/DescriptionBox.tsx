    ...
    <div className="my-[40px] sm:my-[60px] lg:my-[80px] mx-4 sm:mx-8 lg:mx-[170px]">
      <div className="flex border-b border-gray-200">
        <div
          ...
          className={`text-[14px] sm:text-[16px] lg:text-[18px] font-[600] px-[20px] sm:px-[30px] lg:px-[40px] py-[12px] sm:py-[14px] lg:py-[15px] cursor-pointer transition-all ${
      ...
      <div className="border border-gray-200 p-[20px] sm:p-[30px] lg:p-[40px] mt-[2px]">
        {activeTab === "description" ? (
          <div className="flex flex-col gap-[18px] sm:gap-[22px] lg:gap-[25px]">
            <div>
              <h3 className="text-[17px] sm:text-[19px] lg:text-[20px] font-[600] mb-[12px] sm:mb-[14px] lg:mb-[15px]">
                Product Overview
              </h3>
              <p className="text-gray-700 leading-[1.7] sm:leading-[1.8] text-[14px] sm:text-[15px] lg:text-[16px]">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700 leading-[1.7] sm:leading-[1.8] text-[14px] sm:text-[15px] lg:text-[16px]">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-gray-700 text-[14px] sm:text-[15px] lg:text-[16px]">
                <div>
